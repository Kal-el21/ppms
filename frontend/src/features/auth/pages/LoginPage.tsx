...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-surface-secondary">
      {/* Left panel — brand solid color */}
      <div className="hidden lg:flex lg:w-[44%] relative overflow-hidden bg-primary-700 p-12 flex-col justify-between">
        ...
        <div className="relative flex items-center gap-2.5">
          <img src="/assets/brand/logo-indonesia-re.png" alt="Indonesia Re" className="h-[36px] w-auto object-contain" />
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative">
        <button onClick={toggleTheme} className="absolute top-6 right-6 h-9 w-9 rounded-md border border-border bg-surface flex items-center justify-center text-ink-secondary hover:bg-surface-secondary transition-colors cursor-pointer">
          {theme === "light"
        ...
        <div className="w-full max-w-[360px]">
          <div className="lg:hidden flex items-center gap-2.5 mb-8">
            <img src="/assets/brand/logo-indonesia-re.png" alt="Indonesia Re" className="h-[32px] w-auto object-contain" />
          ...
          {step === "credentials" ? (
            ...
            <>
              <button onClick={() => { setStep("credentials"); setErrorMsg(null); }} className="flex items-center gap-1.5 text-[12.5px] text-ink-secondary mb-6 hover:text-ink-primary transition-colors cursor-pointer">
              ...
              <p className="text-center text-[12.5px] text-ink-tertiary mt-5">
                Tidak menerima kode?{" "}
                <button onClick={handleResendOTP} className="text-primary-600 font-medium hover:text-primary-700 cursor-pointer">
                  Kirim ulang
                </button>
              </p>
            </>
